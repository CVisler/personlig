...
SQL_META_DATA: SQLMetaData = {
    'actuals': {
        'alias': [ 'DS_1' ],
        'period': ['202403', '202404', '202405'],#BasePeriod().last_3_months,
        # 'period_sap_entry': # TODO: To be calculated inside Construct class
    ...
    'sst': {
        'alias': [ 'DS_3' ],
        'period': ['202416', '202417', '202418'],#BasePeriod().last_3_weeks,
